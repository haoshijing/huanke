...
CREATE TABLE `t_device`  (
  ...
  `hardVersion` varchar(200)  NULL DEFAULT NULL COMMENT '硬件版本',
  `communicationVersion` varchar(200)  NULL DEFAULT NULL COMMENT '通信版本',
  `softVersion` varchar(200)  NULL DEFAULT NULL COMMENT '软件版本',
  `birthTime` bigint(20) NULL DEFAULT NULL COMMENT '生产日期',  
