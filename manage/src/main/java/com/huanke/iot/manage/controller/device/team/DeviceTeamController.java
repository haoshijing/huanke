...
public class DeviceTeamController {
    ...
    public ApiResponse<Integer> updateTeam(@RequestBody TeamCreateOrUpdateRequest teamCreateOrUpdateRequest){
        //首先查询当前用户是否存在
        ...
        //更新组信息
        this.deviceTeamService.updateTeam(teamCreateOrUpdateRequest);
